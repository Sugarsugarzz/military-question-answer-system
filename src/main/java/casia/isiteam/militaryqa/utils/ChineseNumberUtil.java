...
public class ChineseNumberUtil {
    ...
    private static String convert2Number(List<NumberEnum> numberList) {
        ...
        List<NumberEnum> tempList = new ArrayList<NumberEnum>();
        Long result = 0L;
    ...
    public static void main(String[] args) {
        String number = "大正十一年式37毫米平射狙击炮";
        String number2 = "四十一年式75mm山炮";
        System.out.println(ChineseNumberUtil.convertString(number));
        System.out.println(ChineseNumberUtil.convertString(number2));
    }
